...
appl_bench = 'PT_S38417' # PT_S38417, PT_AES128, PT_Ethernet, PD_S38417, PD_AES128, PD_Ethernet
...
fp = 'v_0.78_' # processed input voltage
X_train_path_single = '../data/model_purpose/'+appl_bench+'/v_0.78_train.pk'
Y_test_path_single = '../data/single_file/v_0.78_train.pk'
X_sub_data_path_single = '../data/single_file/v_0.78_X_sublabels.pk'
...
hidden_dim = 32  # hidden layer dimension 32, modelV5:32, mlp:69
